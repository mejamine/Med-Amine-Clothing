...
<body>
    <header>
        <center class="message">Welcome Sir! Explore your data base!<br>Itachi Hoodies jobs</center>
    </header>
    <?php
    $sql="SELECT * FROM commande_itachi";
    ...
    <div>
        <form action="itachi_config.php" method="POST">
