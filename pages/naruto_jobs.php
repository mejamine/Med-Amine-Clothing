...
<body>
    <header>
        <center class="message">Welcome Sir! Explore your data base!<br>Naruto Hoodies jobs</center>
    </header>
    <?php
    $sql="SELECT * FROM commande_naruto";
    ...
    <div>
        <form action="naruto_config.php" method="POST">
