...
<body>
    <header>
        <center class="message">Welcome Sir! Explore your data base!<br>Demon Slayer Hoodies jobs</center>
    </header>
    <?php
    $sql="SELECT * FROM commande_demonslayer";
    ...
    <div>
        <form action="DS_config.php" method="POST">
